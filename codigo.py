...
# TERCEIRA ETAPA: TORNARÁ O RESUMO DO OLLAMA EM ARQUIVO DE AUDIO
#!pip install git+https://github.com/suno-ai/bark.git
from bark import SAMPLE_RATE, generate_audio, preload_models
#  Instalação necessaria: pip install ipython
from IPython.display import Audio

preload_models()

# Torna o resumo em um audio (processo talvez demorado, dependerá da capacidade de processamete de sua máquina)
text_prompt = f"""
